#!/bin/bash
#SBATCH --job-name=qwen-lora-video
#SBATCH --output=logs/qwen_lora_video_%j.out
#SBATCH --error=logs/qwen_lora_video_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Output
OUTPUT_DIR="../output/lora_video_action_72b_merged"
...
# Validation configuration (high frequency)
EVAL_STRATEGY="steps"
EVAL_STEPS=50
