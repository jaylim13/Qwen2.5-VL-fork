...
def main():
    ...
    if args.use_base_model:
        output_dir = args.output_dir.replace("eval_results", "eval_results_base_model_corrected")
        print(f"📝 Using base model - results will be saved to: {output_dir}")
    elif args.use_merged_model:
        output_dir = args.output_dir.replace("eval_results", "eval_results_merged_model_corrected")
        print(f"📝 Using merged model - results will be saved to: {output_dir}")
    else:
        output_dir = args.output_dir.replace("eval_results", "eval_results_corrected")
